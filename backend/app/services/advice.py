from app.services.mimo_client import (
    generate_advice_with_mimo,
    print_mimo_config_status,
)


def build_rule_based_advice(prediction: dict) -> dict:
...
def build_advice(prediction: dict) -> dict:
    ...
    llm_advice = generate_advice_with_mimo(prediction)

    if llm_advice:
        print("[MIMO] advice generated by model")
        return llm_advice

    print("[MIMO] fallback to rule based advice")
    return build_rule_based_advice(prediction)
